...
public class AnimateGull extends KeyAdapter implements ActionListener {

    private static final float DELTA_DISTANCE = 0.02f;
    private static final float DELTA_ANGLE = 0.05f;

    private Gull gull;
    private TransformGroup gullTransformGroup;
    ...
    public AnimateGull(Gull gull) {
        this.gull = gull;

        this.gullTransformGroup = gull.getGullTransformGroup();
        this.gullTransformGroup.getTransform(this.transform3D);
    ...
    private void Move() {
        ...
        gullTransformGroup.setTransform(transform3D);
    }
