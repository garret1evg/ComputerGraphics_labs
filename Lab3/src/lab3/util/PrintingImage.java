...
public class PrintingImage extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        String filePath = "C:\\Users\\Valzavator\\IdeaProjects\\MAOKG\\Lab3\\resources\\trajectory.bmp";
        ReadingImageFromFile.loadBitmapImage(filePath);
        ...
        pathTransition.setPath(getPathFromBmpFile(filePath));
    ...
    public Path getPathFromBmpFile(String filePath) throws Exception {
        ReadingImageFromFile.loadBitmapImage(filePath);
        this.image = ReadingImageFromFile.pr.image;
        int width = (int) this.image.getWidth();
        int height = (int) this.image.getHeight();
